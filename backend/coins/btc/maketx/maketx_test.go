...
var tltc = btc.NewCoin(coin.CodeTLTC, "Litecoin Testnet", "TBTC", nil, &chaincfg.TestNet3Params, ".", []*config.ServerInfo{}, "", "", socksproxy.NewSocksProxy(false, ""))
var tbtc = btc.NewCoin(coin.CodeTBTC, "Bitcoin Testnet", "TBTC", nil, &chaincfg.TestNet3Params, ".", []*config.ServerInfo{}, "https://mempool.space/testnet/tx/", "https://mempool.space/testnet/address/", socksproxy.NewSocksProxy(false, ""))
