...
func TestAccountsTotalBalanceByKeystore(t *testing.T) {
	...
	b.makeBtcAccount = func(config *accounts.AccountConfig, coin *btc.Coin, gapLimits *types.GapLimits, getAddress func(blockchain.ScriptHashHex) *addresses.AccountAddress, log *logrus.Entry) accounts.Interface {
