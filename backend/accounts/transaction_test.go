...
func TestOrderedTransactions(t *testing.T) {
	...
	txs := []*TransactionData{
		{
			HeaderTimestamp: tt(time.Date(2020, 9, 15, 12, 0, 0, 0, time.UTC)),
			Height:          15,
			Type:            TxTypeReceive,
			Amount:          coin.NewAmountFromInt64(100),
		},
		{
			HeaderTimestamp: tt(time.Date(2020, 9, 10, 12, 0, 0, 0, time.UTC)),
			Height:          10,
			Type:            TxTypeReceive,
			Amount:          coin.NewAmountFromInt64(200),
		},
		{
			HeaderTimestamp: tt(time.Date(2020, 9, 20, 12, 0, 0, 0, time.UTC)),
			Height:          20,
			Type:            TxTypeReceive,
		...
		{
			HeaderTimestamp: tt(time.Date(2020, 9, 11, 12, 0, 0, 0, time.UTC)),
			Height:          11,
			Type:            TxTypeSend,
			Amount:          coin.NewAmountFromInt64(10),
		},
		{
			HeaderTimestamp: tt(time.Date(2020, 9, 21, 12, 0, 0, 0, time.UTC)),
			Height:          21,
			Type:            TxTypeSendSelf,
		...
		{
			HeaderTimestamp:    tt(time.Date(2020, 9, 22, 12, 0, 0, 0, time.UTC)),
			Height:             220,
			Type:               TxTypeSend,
			Amount:             coin.NewAmountFromInt64(5),
			Fee:                &fee,
...
func TestOrderedTransactionsWithFailedTransactions(t *testing.T) {
	...
	txs := []*TransactionData{
		...
		{
			HeaderTimestamp: tt(time.Date(2020, 9, 23, 12, 0, 0, 0, time.UTC)),
			Height:          23,
			Type:            TxTypeReceive,
...
func TestOrderedTransactionsDeductedAmount(t *testing.T) {
	...
	txs := []*TransactionData{
		...
		},
		{
			...
			HeaderTimestamp: tt(time.Date(2020, 9, 16, 12, 0, 0, 0, time.UTC)),
			Height:          15,
			Type:            TxTypeSendSelf,
			Amount:          amount,
			Fee:             &fee,
		},
		{
			...
			HeaderTimestamp: tt(time.Date(2020, 9, 17, 12, 0, 0, 0, time.UTC)),
			Height:          15,
			Type:            TxTypeReceive,
			Amount:          amount,
			Fee:             &fee,
