...
func TestEditionSupport(t *testing.T) {
	btcCoin := btc.NewCoin(coin.CodeTBTC, "Bitcoin Testnet", "TBTC", nil, &chaincfg.TestNet3Params, ".", []*config.ServerInfo{}, "", "", socksproxy.NewSocksProxy(false, ""))
	ltcCoin := btc.NewCoin(coin.CodeTLTC, "Litecoin Testnet", "TLTC", nil, &chaincfg.TestNet3Params, ".", []*config.ServerInfo{}, "", "", socksproxy.NewSocksProxy(false, ""))
