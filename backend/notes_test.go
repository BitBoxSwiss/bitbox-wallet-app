...
func (s *notesTestSuite) SetupTest() {
	...
	s.backend.makeBtcAccount = func(config *accounts.AccountConfig, coin *btc.Coin, gapLimits *types.GapLimits, getAddress func(blockchain.ScriptHashHex) *addresses.AccountAddress, log *logrus.Entry) accounts.Interface {
