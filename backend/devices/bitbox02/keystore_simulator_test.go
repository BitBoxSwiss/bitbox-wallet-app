...
var (
	...
	coinBTC = btc.NewCoin(coinpkg.CodeBTC, "Bitcoin", "BTC", nil, network, ".", []*config.ServerInfo{}, "https://mempool.space/testnet/tx/", "https://mempool.space/testnet/address/", socksproxy.NewSocksProxy(false, ""))
	coinLTC = btc.NewCoin(coinpkg.CodeLTC, "Litecoin", "LTC", nil, &ltc.MainNetParams, ".", []*config.ServerInfo{}, "", "", socksproxy.NewSocksProxy(false, ""))
