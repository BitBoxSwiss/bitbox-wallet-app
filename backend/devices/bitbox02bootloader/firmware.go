...
//go:embed assets/firmware-btc.v9.10.0.signed.bin.gz
var firmwareBinaryBTCOnly []byte
var firmwareVersionBTCOnly = semver.NewSemVer(9, 10, 0)

//go:embed assets/firmware.v9.10.0.signed.bin.gz
var firmwareBinaryMulti []byte
var firmwareVersionMulti = semver.NewSemVer(9, 10, 0)
