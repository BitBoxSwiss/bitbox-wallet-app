...
const (
	...
	// ErrRatesNotAvailable is raised when the latest rates have note been fetched yet.
	ErrRatesNotAvailable errp.ErrorCode = "ratesNotAvailable"
)
