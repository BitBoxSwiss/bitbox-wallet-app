                          ...
                          return insurance ? (
                            <div key={account.code} className={style.row}>
                              <div className="flex flex-items-center">
                                <p className={`${style.text as string} ${style.accountName as string}`}>
                                  {accounts.filter(ac => ac.code === account.code).map(ac => ac.name)}
                                </p>
                                <span className={`${style.text as string} ${style.subtle as string}`}>
                                  { balance ? (
                                    <>
                                      <Amount
                              ...
                              <div className={'m-top-half m-bottom-half'}>
                                <p className={`${style.text as string} ${style.subtle as string} m-bottom-quarter`}>
                              ...
                              <div className="flex flex-column-mobile">
                                <div className="flex">
                                  ...
                                  <p className={`${style.text as string} m-left-quarter m-right-half`}>
                                    {t('bitsurance.dashboard.' + insurance.status)}
                                  </p>
                                </div>
                                <A
                                  className={`${style.text as string} ${style.link as string} m-top-quarter-on-small`}
