...
export const LanguageDropdownSetting = () => {
  ...
  const selectedLanguage =
    defaultLanguages[getSelectedIndex(defaultLanguages, i18n)];
  const formattedLanguages = defaultLanguages.map((lang) => ({
    label: lang.display,
    value: lang.code,
  }));
    ...
    <SettingsItem
      settingName={
        <div className={styles.container}>
          {globe}
          {t('newSettings.appearance.language.title')}
        </div>
      }
      ...
      extraComponent={
        <Dropdown
          ...
          value={{
            label: selectedLanguage.display,
