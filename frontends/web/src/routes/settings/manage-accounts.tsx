        ...
        <div key={account.code} className={style.setting}>
          <div
            ...
            <Logo
              ...
              className={`${style.coinLogo as string} m-right-half`}
          ...
          <div className="flex flex-items-center">
            {!account.active ? (
              <p className={`text-small ${style.disabledText as string}`}>
          ...
          {active && account.coinCode === 'eth' ? (
            <div className={style.tokenSection}>
              <div className={`
                ${style.tokenContainer as string}
