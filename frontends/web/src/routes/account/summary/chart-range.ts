...
export const calculateChartValueDifference = (
  beginningValue: number | undefined,
  endingValue: number | null,
): number | undefined => {
  if (!beginningValue || !Number.isFinite(beginningValue)
    || endingValue === null || !Number.isFinite(endingValue)) {
    return undefined;
  }
