...
export const Addresses = ({ code, accounts, devices }: TProps) => {
  ...
  const renderList = (forcedExpandedAddressID: string | null = null) => {
    ...
    return (
      <div>
                      ...
                      {isChangeAddress ? (
                        <div className={style.addressRow}>
                          <span className={style.rowAddress} title={address.address}>
                            <span className={style.rowAddressDesktop}>{address.address}</span>
        ...
        <div className="hide-on-small" style={{ marginTop: 'var(--space-default)' }}>
          <BackButton enableEsc>
            {t('button.back')}
          </BackButton>
        </div>
          ...
          {isError && (
            <div className={style.verifyDialogError}>
              ...
              <div className={style.footerButtons}>
                ...
                <Button secondary onClick={() => returnToList(selectedAddress?.addressID)}>
                  {t('button.back')}
                </Button>
              </div>
            </div>
  ...
  return (
    <Main>
      ...
      <Header hideSidebarToggler title={renderHeaderTitle()} />
