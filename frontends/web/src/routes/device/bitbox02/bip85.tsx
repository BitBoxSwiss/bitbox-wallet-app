...
export const Bip85 = ({ deviceID }: TProps) => {
  ...
  switch (status) {
    case 'info-what':
      return (
        <View key="bip85-info-what" fullscreen verticallyCentered>
          ...
          <ViewButtons>
            <Button primary onClick={() => setStatus('info-how')}>
              {t('button.continue')}
            </Button>
    ...
    case 'info-how':
      return (
        <View key="bip85-info-how" fullscreen verticallyCentered>
          ...
          <ViewButtons>
            <Button primary onClick={() => setStatus('info-recover')}>
              {t('button.continue')}
            </Button>
            <Button secondary onClick={() => setStatus('info-what')}>
              {t('button.back')}
            </Button>
          </ViewButtons>
        </View>
    ...
    case 'info-recover':
      return (
        <View key="bip85-info-recover" fullscreen verticallyCentered>
          ...
          <ViewButtons>
            ...
            <Button secondary onClick={() => setStatus('info-how')}>
              {t('button.back')}
            </Button>
          </ViewButtons>
        </View>
    ...
    case 'info-security':
      return (
        <View key="bip85-info-security" fullscreen verticallyCentered>
          <ViewHeader title={t('deviceSettings.expert.bip85.security.title')} />
          <ViewContent minHeight="280px">
            <p>{t('deviceSettings.expert.bip85.security.description')}</p>
            <Checkbox
              id="understood"
              onClick={(e) =>
                setDisclaimer((e.target as HTMLInputElement).checked)
              }
            >
          ...
          <ViewButtons>
            ...
            <Button secondary onClick={() => setStatus('info-recover')}>
              {t('button.back')}
            </Button>
          </ViewButtons>
        </View>
    ...
    case 'progress':
      return (
        <View key="bip85-progress" fullscreen textCenter verticallyCentered>
