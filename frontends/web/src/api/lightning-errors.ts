...
export enum TLightningErrorCode {
  ...
  PAYMENT_ATTEMPT_CHANGED = 'lightningPaymentAttemptChanged',
  PAYMENT_NOT_FINAL = 'lightningPaymentNotFinal',
  PAYMENT_PREPARATION_FAILED = 'lightningPaymentPreparationFailed',
  TOP_UP_CLAIM_FAILED = 'lightningTopUpClaimFailed',
  TOP_UP_REFUND_FAILED = 'lightningTopUpRefundFailed',
...
const lightningErrorTranslationKeys: Partial<Record<string, string>> = {
  ...
  [TLightningErrorCode.PAYMENT_ATTEMPT_CHANGED]: 'error.lightningPaymentAttemptChanged',
  [TLightningErrorCode.PAYMENT_NOT_FINAL]: 'error.lightningPaymentNotFinal',
  [TLightningErrorCode.PAYMENT_PREPARATION_FAILED]: 'error.lightningPaymentPreparationFailed',
  [TLightningErrorCode.TOP_UP_CLAIM_FAILED]: 'error.lightningTopUpClaimFailed',
  [TLightningErrorCode.TOP_UP_REFUND_FAILED]: 'error.lightningTopUpRefundFailed',
