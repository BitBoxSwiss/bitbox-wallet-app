    ...
    <Dialog
      ...
      {transactionInfo && (
        <div className={styles.container}>
          ...
          {type && (
            <TxDetailRow>
              <p className={styles.label}>{type === 'send' ? t('send.confirm.to') : t('transaction.details.from')}</p>
          ...
          <TxDetailRow>
            ...
            <span>{displayedSign}<AmountWithUnit amount={transactionInfo.fee} unitClassName={styles.rowUnit} /></span>
          </TxDetailRow>
