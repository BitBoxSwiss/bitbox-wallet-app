...
import outlinedFileProtectSVG from './assets/icons/outlined-file-protect.svg';
...
export const OutlinedFileProtect = (props: ImgProps) => (<img src={outlinedFileProtectSVG} draggable={false} {...props} />);
