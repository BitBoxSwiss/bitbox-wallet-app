...
import fastForwardWhiteSVG from './assets/icons/fast-forward-white.svg';
...
export const FastForwardWhite = (props: ImgProps) => (<img src={fastForwardWhiteSVG} draggable={false} {...props} />);
