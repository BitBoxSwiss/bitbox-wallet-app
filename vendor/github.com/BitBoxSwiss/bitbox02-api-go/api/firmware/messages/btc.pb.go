...
func file_btc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_btc_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_btc_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
	...
	file_btc_proto_msgTypes[6].OneofWrappers = []interface{}{}
	...
	file_btc_proto_msgTypes[19].OneofWrappers = []interface{}{
	...
	file_btc_proto_msgTypes[22].OneofWrappers = []interface{}{
