...
func (x *Request) GetBitboxSync() *BitBoxSyncRequest {
	if x != nil {
		if x, ok := x.Request.(*Request_BitboxSync); ok {
			return x.BitboxSync
		}
	}
	return nil
...
type Request_BitboxSync struct {
...
func (x *Response) GetBitboxSync() *BitBoxSyncResponse {
	if x != nil {
		if x, ok := x.Response.(*Response_BitboxSync); ok {
			return x.BitboxSync
		}
	}
	return nil
...
type Response_BitboxSync struct {
